...
```text
C:\Users\39165\Desktop\APPDEV
```

### Android Studio 開啟路徑

請在 Android Studio 選擇 Open，開啟以下資料夾：

```text
C:\Users\39165\Desktop\APPDEV
```

如果是其他組員從 GitHub clone，請開啟自己電腦上的 `APPDEV` 專案根目錄。不要只開 `app/` 資料夾，因為 Gradle Wrapper、根目錄 `build.gradle`、`settings.gradle` 都在專案根目錄。
...
| 用途 | 路徑 |
|---|---|
| 根目錄 Gradle 設定 | `C:\Users\39165\Desktop\APPDEV\build.gradle` |
| Gradle 專案模組設定 | `C:\Users\39165\Desktop\APPDEV\settings.gradle` |
| Android App Gradle 設定 | `C:\Users\39165\Desktop\APPDEV\app\build.gradle` |
| Gradle Wrapper | `C:\Users\39165\Desktop\APPDEV\gradlew.bat` |
| Android Manifest | `C:\Users\39165\Desktop\APPDEV\app\src\main\AndroidManifest.xml` |
| 本機 API key 設定 | `C:\Users\39165\Desktop\APPDEV\local.properties` |
...
```text
C:\Users\39165\Desktop\APPDEV\local.properties
```
...
1. 開啟 Android Studio。
2. 選擇 Open。
3. 選擇專案根目錄：`C:\Users\39165\Desktop\APPDEV` 或自己 clone 的 `APPDEV` 資料夾。
4. 等待 Gradle Sync。
...
```powershell
cd C:\Users\39165\Desktop\APPDEV
$env:JAVA_HOME='C:\Program Files\Android\Android Studio\jbr'
$env:Path="$env:JAVA_HOME\bin;$env:Path"
```
...
```text
C:\Users\39165\Desktop\APPDEV\app\build\outputs\apk\debug\app-debug.apk
```
...
```text
C:\Users\39165\Desktop\APPDEV\backend
```

進入後端資料夾：

```powershell
cd C:\Users\39165\Desktop\APPDEV\backend
```
...
```text
C:\Users\39165\Desktop\APPDEV\docs\report.md
```
...
```text
C:\Users\39165\Desktop\APPDEV\docs\slides.pdf
```

簡報文字大綱路徑：

```text
C:\Users\39165\Desktop\APPDEV\docs\slides_outline.md
```
